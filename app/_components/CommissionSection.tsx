    ...
    <section className="relative overflow-hidden bg-white px-5 py-20">
      ...
      <div className="relative z-10 mx-auto max-w-md">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            {/* 모바일: 가로 바 / PC: 좌측 패널 */}
            <div className="flex flex-row items-center justify-center gap-3 bg-primary px-4 py-3 sm:w-[36%] sm:flex-col sm:items-center sm:justify-between sm:px-2 sm:pb-3 sm:pt-4">
              <Image src="/icons/3d/things.png" alt="가전결합상조" width={52} height={52} className="object-contain sm:h-22.5 sm:w-22.5" />
              <span className="text-sm font-bold text-white sm:text-[11px]">가전결합상조</span>
            </div>
            {/* 내용 */}
            <div className="flex flex-col items-center justify-center gap-2 bg-white px-5 py-5 sm:w-[64%]">
          ...
          <div
            ...
            style={{ boxShadow: "0 4px 20px rgba(27,94,191,0.13)" }}
          >
            <div className="flex flex-row items-center justify-center gap-3 bg-sky-bg px-4 py-3 sm:w-[36%] sm:flex-col sm:items-center sm:justify-between sm:px-2 sm:pb-3 sm:pt-4">
              <Image src="/icons/3d/picture.png" alt="순수상조" width={52} height={52} className="object-contain sm:h-22.5 sm:w-22.5" />
              <span className="text-sm font-bold text-primary sm:text-[11px]">순수상조</span>
            </div>
            <div className="flex flex-col justify-center bg-white px-4 py-3 sm:w-[64%]">
          ...
          >
            <div className="flex flex-row items-center justify-center gap-3 bg-primary px-4 py-3 sm:w-[36%] sm:flex-col sm:items-center sm:justify-between sm:px-2 sm:pb-3 sm:pt-4">
              <Image src="/icons/3d/clock.png" alt="즉시상조" width={52} height={52} className="object-contain sm:h-22.5 sm:w-22.5" />
              <span className="text-sm font-bold text-white sm:text-[11px]">즉시상조</span>
            </div>
            <div className="flex flex-col justify-center bg-white px-4 py-3 sm:w-[64%]">
              <div className="divide-y divide-gray-100">
